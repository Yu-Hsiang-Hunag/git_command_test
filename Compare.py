...
# -------------------------------------------------------------------------------------------------------------------- #
# Getting input file from JIRA ticket and output file folder from JIRA ticket information
# -------------------------------------------------------------------------------------------------------------------- #
...
def jira_ticket(username, passwd, ticket):
    ...
    input_file_path = os.path.join(SCRIPT_REAL_PATH, input_file_name)
...
# -------------------------------------------------------------------------------------------------------------------- #
def main():
    log_file_path = os.path.join(SCRIPT_REAL_PATH, "Compare_Result.log")
    logging.basicConfig(filename=log_file_path, filemode="w",format='%(asctime)s %(levelname)-5s: %(message)s', datefmt='%Y-%m-%d_%H:%M:%S', level=logging.DEBUG)
